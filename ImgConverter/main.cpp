...
class PPM_IFI : public ImageFormatInterface {
...
class JPEG_IFI : public ImageFormatInterface {
    bool SaveImage(const img_lib::Path& file, const img_lib::Image& image) const override {
...
class BMP_IFI : public ImageFormatInterface {
    bool SaveImage(const img_lib::Path& file, const img_lib::Image& image) const override {
...
const ImageFormatInterface* GetFormatInterface(const img_lib::Path& path) {
    ...
    static const PPM_IFI ppmInterface;
    static const JPEG_IFI jpegInterface;
    static const BMP_IFI bmpInterface;
